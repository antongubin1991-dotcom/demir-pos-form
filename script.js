...
============================================================ */
// Укажи свой URL, когда будет готов, пока пусть будет пустая строка
...
if (savePdfBtn) {
  savePdfBtn.addEventListener("click", async () => {
    ...
    // 2. Отправляем в SLK (или просто логируем, если SLK_ENDPOINT пустой)
    await sendToSLK(formData);

    // 3. Заполняем PDF и генерим файл
    fillPdfTemplate();
